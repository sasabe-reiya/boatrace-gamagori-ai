...
SCORE_WEIGHTS = {
    ...
    "win_rate":         1.099,    # 全国勝率の重み
    "local_win_rate":   0.858,    # 蒲郡勝率の重み
    "nat2_rate":        2.226,    # 全国2連率の重み
    "loc2_rate":        0.481,    # 蒲郡2連率の重み
    "exhibit_time":     0.561,    # 展示タイム偏差の重み
    "exhibit_top_bonus": 1.54,    # 展示1位ボーナス
    "night_boost":      0.656,    # ナイター補正加点（1号艇）
    "calm_in_boost":    1.704,    # 風弱→イン加点
