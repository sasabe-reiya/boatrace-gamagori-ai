...
SCORE_WEIGHTS = {
    ...
    "makuri_sashi":     5.312,    # まくり差し補正（3号艇）
    "st_weight":        36.216,    # STの重み（0.01秒差 = 0.25点）
    ...
    "lap_time":         0.93,    # 一周タイムの重み
    "mawari_time":      0.711,    # まわり足タイムの重み（ターン力）
    "chokusen_time":    2.376,    # 直線タイムの重み（伸び足）
    "turn_master_bonus": 3.263,    # ターン巧者ボーナスの重み
